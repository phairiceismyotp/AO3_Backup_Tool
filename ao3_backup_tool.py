...
def extract_work_id(raw: str) -> str | None:
    ...
    Accepts any of the following input forms:
      - Bare numeric ID:    00000000
      - Full AO3 URL:       https://archiveofourown.org/works/00000000/chapters/...
      - AO3 download URL:   https://download.archiveofourown.org/downloads/00000000/...
